                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: Kolkata, West Bengal </p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+91) - 7004601911 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> riteshrajput.1217@gmail.com</p>
                            ...
                            <div className='col-md-3 part3  part_3'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    <li className='list-inline-item'>
                                            <Link to={'https://www.linkedin.com/in/ritesh-singh-298328258/'}><LinkedIn /></Link>
                                        </li>
                                        <li className='list-inline-item'>
                                            <Link to={'https://github.com/Ritesh1217'}><GitHub /></Link>
                                        </li>
